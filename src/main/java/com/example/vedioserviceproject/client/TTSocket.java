package com.example.vedioserviceproject.client;

import com.example.vedioserviceproject.dto.UserServiceDTO;
...
public class TTSocket {
    ...
    // 服务客户端对象
    private UserServiceDTO.Client client;
    ...
    public TTSocket(String host, Integer port) {
        ...
        client = new UserServiceDTO.Client(tProtocol);
    }
     ...
     * @return
     */
    public UserServiceDTO.Client getService() {
        return client;
    }
